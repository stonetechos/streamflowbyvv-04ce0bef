...
export const hiINBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "room.participant.badge.ready": "तैयार",
    "room.participant.badge.launched": "सेवा खोली",
    "room.participant.badge.live": "लाइव",
    "room.participant.badge.stale": "सिग्नल पुराना",
    "room.participant.badge.offline": "ऑफ़लाइन",
    "room.participant.badge.manual": "मैन्युअल सिंक",
    "party.region_label": "वॉच पार्टी — {name}",
    "party.control.mic_on": "माइक चालू",
    "party.control.mic_off": "माइक बंद",
    "party.control.menu": "रूम सेटिंग्स",
    "party.rail.label": "इस पार्टी के लोग",
    "party.rail.host_of": "{name} (होस्ट)",
    "party.rail.invite": "दोस्त को बुलाएँ",
    "party.invite.title": "दोस्त को बुलाएँ",
    "party.invite.share": "शेयर करें",
    "party.invite.copy": "लिंक कॉपी करें",
    "party.invite.key": "रूम की",
    "party.invite.code_copied": "रूम की कॉपी हो गई।",
    "party.invite.empty": "अभी यहाँ सिर्फ़ आप हैं।",
    "party.message.placeholder": "पार्टी में संदेश भेजें",
    "party.sheet.room": "रूम",
    "room.console.phase.lobby": "लॉबी",
    "room.console.phase.counting_down": "गिनती चल रही है",
    "room.console.phase.watching": "देख रहे हैं",
    "room.console.phase.paused": "होस्ट ने रोका",
    "room.console.phase.manual": "मैन्युअल सिंक मोड",
    "room.console.clock.measured": "रूम समय",
    "room.console.clock.declared": "होस्ट द्वारा बताया समय",
    "room.console.clock.none": "अभी शुरू नहीं हुआ",
    "room.console.people": "{count} मौजूद · {ready} तैयार · {launched} ने खोला",
    "room.console.untitled": "{provider} पर देख रहे हैं",
    "room.console.disclosure.no_read": "StreamFlow अभी आपका {provider} प्लेयर नहीं पढ़ सकता।",
    "room.console.disclosure.manual": "साथ रहने के लिए काउंटडाउन या मैन्युअल सिंक का उपयोग करें।",
    "room.console.action.start": "हम शुरू कर रहे हैं",
