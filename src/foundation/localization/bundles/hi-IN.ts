...
export const hiINBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "theater.stage.guest_waiting": "होस्ट के चुनने का इंतज़ार है।",
    "theater.stage.status.waiting": "अभी कुछ नहीं चुना गया।",
    "theater.stage.status.selected": "चुन लिया गया — सब तैयार हों तो होस्ट काउंटडाउन शुरू करेगा।",
    "theater.stage.status.countdown": "काउंटडाउन चल रहा है। प्ले दबाने के लिए तैयार रहें।",
