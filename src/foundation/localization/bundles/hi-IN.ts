...
export const hiINBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "compliance.rationale.no_automation": "इस सेवा की शर्तें स्वचालित नियंत्रण की अनुमति नहीं देतीं।",
    "compliance.rationale.no_drm_bypass": "हर कोई अपने खाते से देखता है। StreamFlow कभी सुरक्षा नहीं तोड़ता।",
    "compliance.rationale.no_redistribution": "वीडियो StreamFlow से होकर नहीं जाता। कुछ भी साझा नहीं किया जाता।",
    "compliance.rationale.no_credentials": "StreamFlow आपके खाते की जानकारी न मांगता है, न संग्रहित करता है।",
    "compliance.rationale.region_restricted": "उपलब्धता आपके क्षेत्र और सदस्यता पर निर्भर है।",
    "compliance.rationale.manual_sync_only": "प्लेबैक आपके हाथ में रहता है — हम केवल क्षण तय करते हैं।",
    "compliance.rationale.unverified": "हमने इस सेवा की शर्तें अभी सत्यापित नहीं की हैं।",
