...
export const hiINBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "theater.netflix.open": "Netflix खोलें",
    "theater.netflix.instruction": "Netflix पर टाइटल चुनें, फिर लौटकर उसका लिंक यहाँ चिपकाएँ। StreamFlow आपके लिए साइन-इन नहीं करता और Netflix को रूम के अंदर नहीं चलाता।",
    "theater.netflix.returned": "Netflix से लौट आए? नीचे टाइटल लिंक चिपकाएँ।",
    "theater.netflix.paste_label": "Netflix टाइटल लिंक",
    "theater.netflix.paste_description": "काउंटडाउन खत्म होने पर हर कोई इसे अपने अकाउंट पर खोलता है।",
    ...
    "theater.source.description": "साथ चलाने के लिए YouTube लिंक चिपकाएँ, या समन्वय के लिए कोई और लिंक।",
