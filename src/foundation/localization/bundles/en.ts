...
export const enBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "theater.netflix.open": "Open Netflix",
    "theater.netflix.instruction": "Pick the title on Netflix, then come back and paste its link here. StreamFlow never signs in for you and never plays Netflix inside the room.",
    "theater.netflix.returned": "Back from Netflix? Paste the title link below.",
    "theater.netflix.paste_label": "Netflix title link",
    "theater.netflix.paste_description": "Everyone opens it on their own account when the countdown ends.",
    ...
    "theater.source.description": "Paste a YouTube link to play it together, or any other link to coordinate around it.",
