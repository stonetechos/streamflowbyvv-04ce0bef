...
export const enBundle: LocaleBundle = {
  ...
  strings: {
    ...
    "compliance.rationale.no_automation": "This service's terms don't allow automated playback control.",
    "compliance.rationale.no_drm_bypass": "Everyone watches through their own account. StreamFlow never bypasses protection.",
